...
class CharacterControllerTest {
    ...
    void getById_returnsCharacterSheetWithAllBodyGroups() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/characters/keynor-1"))
                ...
                .andExpect(jsonPath("$.body.attributes.manaPool").value(12.0))
                .andExpect(jsonPath("$.body.attributes.arcaneOutput").value(12.0))
                .andExpect(jsonPath("$.body.attributes.sixthSense").value(12.0))
