...
class CharacterControllerTest {
    ...
    void getById_returnsCharacterSheetWithAllBodyGroups() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/characters/keynor-1"))
                ...
                .andExpect(jsonPath("$.mind.erudition.selectedTraits").isEmpty())
                .andExpect(jsonPath("$.mind.erudition.freeTraitSlots").value(2))
                ...
                .andExpect(jsonPath("$.attributes.manaPool").value(12.0))
                ...
                .andExpect(jsonPath("$.attributes.illusionResistanceSanity").value(60.0))
