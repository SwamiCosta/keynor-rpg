...
import com.keynor.rpg.application.usecase.ClownChatService;
...
public class DomainConfiguration {
    ...
    @Bean
    public ChatWithClownUseCase chatWithClownUseCase(ClownAssistantPort clownAssistantPort) {
        return new ClownChatService(clownAssistantPort);
    }
}
